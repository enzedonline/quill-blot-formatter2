...
Functionality, this was a minor update that allows empty `alt` tags on images. Previously these were removed if encountered.
...
### Demos
 ...
 - [React](https://codesandbox.io/p/sandbox/react-blot-formatter2-ctjqmp) - using Quill with React and BlotFormatter2. This example shows you how to use the native Quill object with React and avoid the bugs that come with the wrapper library (`react-quilljs`).
